	...
	return (
		<div className="mx-auto flex w-full max-w-xl flex-col items-center py-12">
			<div className="mx-auto flex w-full flex-col items-center justify-center">
				<div className="mb-8 flex h-11 w-11 items-center justify-center rounded-xl border border-border-soft bg-surface/80 text-xs font-semibold text-text shadow-sm">
					OTP
				</div>
				...
				<div className="mt-10 w-full">
					...
					<div className="mt-6 text-center">
						<button
							...
							className="text-sm font-medium text-muted transition-colors duration-300 hover:text-text disabled:cursor-not-allowed disabled:opacity-50"
						>
