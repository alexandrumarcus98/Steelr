	...
	return (
		<div className="w-full max-w-4xl mx-auto px-4 py-8">
			<div className="mb-8">
				<Link
					to="/"
					className="mb-4 inline-flex items-center gap-2 text-sm text-muted hover:text-slate-900 "
				>
					← Back to Home
				</Link>
				...
				<p className="text-base text-muted">Posts you've viewed recently</p>
			</div>
			...
			{status === "loading" ? (
				...
				<div className="rounded-lg border border-border-soft bg-surface/70 p-8 text-center">
					<p className="text-muted">You haven't visited any posts yet. Start exploring!</p>
					<Link
