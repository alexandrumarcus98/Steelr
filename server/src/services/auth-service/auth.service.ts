...
export const loginUser = async (body: LoginBody): Promise<AuthResult | null> => {
...
export const createPasswordReset = async (body: ForgotPasswordBody): Promise<{ emailSent: boolean }> => {
  const { email } = body;
